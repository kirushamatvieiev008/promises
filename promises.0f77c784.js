...
toggleUserState(users, 'Mango').then(logger);
toggleUserState(users, 'Mango').then(logger); // toggleUserState(users, 'Mango', logger);
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire8b27", {})

//# sourceMappingURL=promises.0f77c784.js.map
